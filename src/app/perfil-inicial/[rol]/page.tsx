...
// Definición del componente principal (extraído de PerfilInicial.tsx)
...
const PerfilInicial: React.FC<{ defaultRole: UserRole, userName: string, currentUserId: string }> = ({ 
    ...
    const [perfilData, setPerfilData] = useState(
        defaultRole === 'Paciente' ? {} : {} // Estado inicial vacío para llenado
    );

    const [loading, setLoading] = useState(false);
    const [error, setError] = useState('');
    // 1: Datos principales (Paciente o Psicólogo), 2: Personalización del Avatar (solo Paciente)
...
// Componente Wrapper para la página dinámica
const PerfilInicialPage = () => {
    ...
    // Obtener el rol del segmento dinámico de la URL
